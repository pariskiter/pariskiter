...
<p align="center">
  ...
  <a href="mailto:pariskiter@gmail.com">
    <img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>

  <a href="https://github.com/pariskiter/Projects">
...
### 紐約大學 Stern 商學院 商業分析與人工智慧碩士（STEM）

📍 台北，台灣

畢業於紐約大學 Stern 商學院 Business Analytics & AI 碩士，擁有 5 年媒體數據分析經驗。

目前正投入資料分析與人工智慧領域，專注於商業分析、客戶分析、機器學習、推薦系統，以及以數據驅動商業決策。

目前持續開發 AI 專案、參與 Hackathon，並持續學習雲端技術與大型語言模型（LLM）應用。
...
| 年份 | 競賽／獎項 | 主辦單位 | 成績 | 規模 |
|------|------------|----------|------|------|
| 2025 | 🥇 MSBAI Kaggle Competition – Amazon Recommender System | NYU Stern MSBAi | 第 1 名 | Top 2% · 1/37 |
...
| 期間 | 職位 |
|------|------|
| **2023 年 4 月 – 2023 年 9 月**<br>台北，台灣 · 全職現場 | **社群編輯 &#124; 側重受眾數據分析**<br>[杰德影音](https://www.porticomedia.com/) · 正職 |
